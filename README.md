...
| 05: Error prevention | Bad: Does not put a clear enough signal when the download fails, it only says that the text is "queued". Only lets you know it failed when you click on that button. | 3 | It is very important to fix this aspect
